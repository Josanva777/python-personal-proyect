...
with col2:
    st.markdown('<h3 style="color: #0066cc; margin-top: 0px;">Johan Sánchez Valencia</h3>', unsafe_allow_html=True)
    ...
    st.markdown('<p>Repositorio: <a href="https://github.com/Josanva777/python-personal-proyect.git" target="_blank" style="color: #0066cc; font-weight: bold; text-decoration: none;">GitHub</a></p>', unsafe_allow_html=True)
